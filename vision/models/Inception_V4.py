...
class Stem(nn.Module):
    def __init__(self, in_channels):
        ...
        self.conv2d_1a_3x3 = Conv2d(in_channels, 32, 32, stride=2, padding=0, bias=False)
...
writers = SummaryWriter(log_dir='../logs/GoogLeNet_Inception/Inception_V4')
model = Inceptionv4()
print(model)
writers.add_graph(model, torch.rand(1, 3, 224, 224))
writers.close()
